...
export const plans = [
	...
	/* keep this here as a skeleton for future subscription tiers,
	{
								...
								<ul className="space-y-2.5 leading-relaxed text-base flex-1">
									{[
										...
										<li key={i} className="flex items-center gap-2">
											{/* the svg is the image we need to change */}
											<svg
				...
				> 
					<div className="flex gap-1 items-center">
						...
						<span className="font-bold text-base-content flex gap-0.5 items-center tracking-tight">
							{/* WE NEED TO PLUG IN OUR IMAGE HERE
							<Image
								src={logo}
								alt="ShipFast logo"
								priority={true}
