	...
	return (
		<div>
			...
			<div className="flex flex-col overflow-hidden items-center h-auto w-full bg-[#fff9EB]">
				<h1 className="pt-20 text-5xl md:text-5xl text-center font-semibold text-[#010102] w-auto md:w-5/12">Professional advertisements without the hassle</h1>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 h-auto w-auto">
						<div className="flex flex-col border-b-2 md:border-r-2 md:border-b-2 border-gray-400 items-center justify-center px-8 2xl:px-16 py-20 gap-16">
							...
							<div className="flex flex-col items-center justify-center text-center w-full gap-6">
								<h1 className="text-3xl font-semibold text-[#010102]">Create clips with ease</h1>
								<p className="text-lg font-normal text-gray-600">Lorem ipsum dolor sit amet consequat facilisis consequat ultrices suspendisse faucibus mauris</p>
							</div>
							<Link href='about'>
